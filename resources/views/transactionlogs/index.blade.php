...
@section('content')
    ...
    <div x-data="{ isModalOpen: false }">
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            {{-- Awalnya disembunyikan, Alpine.js yang mengontrol --}} x-on:keydown.escape.window="isModalOpen = false" {{-- Tutup modal dengan tombol Escape --}}>
            {{-- Konten Modal --}}
            <div class="bg-white rounded-xl shadow-2xl p-6 md:p-8 w-full max-w-2xl transform transition-all overflow-y-auto max-h-[90vh]"
                ...
                <form action="#" method="POST" id="addSalesForm">
                    ...
                    <div class="mt-8 pt-5 border-t border-gray-200 flex items-center justify-end space-x-3">
                        ...
                        <button type="submit" {{-- Ubah ke type="button" jika hanya simulasi frontend --}} {{-- x-on:click="isModalOpen = false" --}} {{-- Bisa ditambahkan jika ingin langsung menutup setelah simpan (untuk demo) --}}
