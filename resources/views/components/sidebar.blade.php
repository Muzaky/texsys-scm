    ...
    <nav class="flex-grow">
        <ul>
            ...
            <li class="mb-3">
                <a href="{{ route('logout') }}"
                    class="flex items-center p-3 rounded-lg 
                {{ str_starts_with(Route::currentRouteName(), 'logout') ? 'bg-purple-100 text-purple-700 font-normal' : 'text-gray-600 hover:bg-gray-100' }}">
                    <i class="fas fa-chart-line mr-3"></i>Logout
                </a>
            </li>
